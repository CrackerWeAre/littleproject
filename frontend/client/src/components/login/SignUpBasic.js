            ...
            <div className="account__form">
                <form onSubmit={data.onSubmit} method="post">
                    <div className="box">
                        ...
                        <div className="account__field">
                            <label htmlFor="username" className="hidden">성별추가</label>
                            <div className="form__text">
                                <label htmlFor="username" className="hidden">성별을 입력해주세요.</label>
                            </div>
                            <div className="form__text">
                                <label htmlFor="username" className="hidden">
                                남<input type="radio" name="gender" value="men" onChange={data.onChangeGender}/>
                                여<input type="radio" name="gender" value="women" onChange={data.onChangeGender}/>
                                </label>
                            </div>
                        </div>
                        <div className="account__field">
                            ...
                            <div className="form__input">
                                <select name="user_birth_year" id="birthyear" defaultValue={2000} onChange={data.onChangeYear}>
